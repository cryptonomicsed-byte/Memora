...
///   * buyback: a keeper agent swaps it for IMMUTEX on a DEX and calls
...
/// Holder tiers: fee discount in bps for a given amount of locked IMMUTEX (9 decimals).
///   Tier 1 >= 1,000 IMMUTEX: 20% off
///   Tier 2 >= 25,000 IMMUTEX: 40% off (plus priority portal routing, enforced off-chain)
///   Tier 3 >= 250,000 IMMUTEX: 60% off (plus continuous Sentinel monitoring)
